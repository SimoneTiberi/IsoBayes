...
* 'Prob_present': the protein isoform probability of being present in the biological sample;
* 'Abundance': protein isoform abundance  CI_LB CI_UB           Pi     Pi_CI_LB


we have the lists all the isoforms names with 
```{r get iso res}
