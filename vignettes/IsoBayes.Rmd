...
```{r load psm}
PSM_data_loaded = load_data(x = path_to_peptides_psm,
...
Percolator_data_loaded = load_data(x = "/path/to/file.idXML",
                                   input_type = "openMS",
                                   path_to_tpm = tpm_path)
```
...
Other_data_loaded = load_data(x = "/path/to/user_data.tsv",
                              input_type = "other",
                              path_to_tpm = tpm_path)
```
