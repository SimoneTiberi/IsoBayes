run_MCMC_pep = function(pept_df, pept_unique_df, prot_df, protein_length, N, M, M_unique, prior, lib_size, params){
  if(prior == 0){
  ...
  if(params$n_cores > 1){
    res = parallel_MCMC_pep(pept_df, pept_unique_df, prot_df, protein_length, pp, N, params)
  }else{
